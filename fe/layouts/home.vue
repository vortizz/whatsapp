<template>
  <div class="size-full flex flex-row justify-start">
    <aside
      class="flex flex-col p-3 justify-between w-16 border-r border-black/10 bg-stone-100 dark:border-white/10 dark:bg-neutral-800"
    >
      <div class="flex flex-col gap-0.5">
        ...
        >
          <span
            ...
            class="absolute -right-1 -top-2 rounded-full text-xs text-white dark:text-neutral-950 bg-emerald-500 py-0.5 px-1.5 font-semibold z-10 border-2 border-solid border-stone-100 dark:border-neutral-800"
          >
            {{ unreadChatsCount }}
          </span>
          <Icon
            :name="
              currentPage === Pages.CHATS
