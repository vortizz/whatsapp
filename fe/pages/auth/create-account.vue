  ...
  >
    <form @submit.prevent="onSubmit">
      ...
      <div class="flex flex-col mt-6 gap-6">
        ...
        <div class="flex flex-col gap-1">
          <label for="email" class="uppercase text-xs font-semibold dark:text-zinc-300"
            >E-mail</label
          >
          <input
            v-model="form.email"
        ...
        <div class="flex flex-col gap-1">
          <label for="confirmPassword" class="uppercase text-xs font-semibold dark:text-zinc-300"
          ...
          <div class="relative">
            ...
            <button
              type="button"
              class="absolute inset-y-0 right-0 text-slate-400 px-4 text-lg"
