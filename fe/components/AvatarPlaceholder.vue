<template>
    ...
    >
        <span v-if="hasName" :style="textStyle" class="font-semibold text-white select-none leading-none">
            {{ initials }}
        </span>
        <Icon v-else :name="group ? 'solar:users-group-rounded-bold' : 'solar:user-bold'" :style="iconStyle" />
    </div>
</template>
