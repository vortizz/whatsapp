    ...
    <div class="flex flex-col px-[18px]">
        ...
        >
            ...
            <div>
                ...
                <div class="dark:text-white/60 text-black/60 text-sm">Name, profile photo, about, email</div>
            </div>
        </div>
        <div 
        ...
        >
            <div class="py-2 pl-2 pr-4 flex items-center">
                <Icon name="material-symbols:logout-rounded" class="text-2xl dark:text-rose-500 text-rose-600" />
            </div>
            <div class="dark:text-rose-500 text-rose-600">
                Log out
            </div>
        </div>
    </div>
