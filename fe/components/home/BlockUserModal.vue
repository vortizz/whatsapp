    ...
    >
      <div class="w-full max-w-lg rounded-2xl bg-white py-5 px-6 shadow-2xl dark:bg-neutral-800">
        ...
        <div class="max-w-3xl text-sm leading-relaxed text-neutral-500 dark:text-white/60">
          This person won't be able to message or call you. They won't know you blocked or reported
          them.
        </div>
...
<script setup>
  const { isOpen, targetUser, isBlockingUser, isBlockUserDisabled, closeModal, confirmBlockUser } =
    useBlockUserModal()
</script>
