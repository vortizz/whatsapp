<template>
    <aside class="flex-1 min-w-80 bg-white dark:bg-neutral-900 border-r border-gray-200 dark:border-black/80 flex flex-col">
        <header class="sticky top-0 z-10">
            <HomeNewGroupHeader :step="step" @close="handleClose" />
        </header>
        <main class="flex flex-col flex-1 overflow-y-auto scrollbar scrollbar-w-2 scrollbar-thumb-gray-300 scrollbar-track-transparent">
