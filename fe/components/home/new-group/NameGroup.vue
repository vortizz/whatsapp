<template>
    <div class="flex flex-col items-center gap-8 px-6 pt-10">
        ...
        <div class="w-24 h-24 rounded-full bg-stone-300 dark:bg-neutral-600 flex flex-col items-center justify-center gap-1 text-white cursor-default select-none">
        ...
        <button
            ...
            @click="create"
        >
            <svg v-if="loading" aria-hidden="true" role="status" class="w-5 h-5 animate-spin" viewBox="0 0 100 101" fill="none">
