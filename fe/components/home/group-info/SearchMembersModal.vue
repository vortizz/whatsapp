<template>
  <Teleport to="body">
    ...
    >
      <div
        class="w-full max-w-[436px] rounded-2xl bg-white dark:bg-neutral-900 shadow-2xl flex flex-col"
      ...
      >
        ...
        <div class="px-4 pb-3">
          <div
            class="flex items-center gap-2 bg-gray-100 dark:bg-neutral-700 rounded-full px-3.5 py-3 focus-within:ring-2 focus-within:ring-emerald-500 focus-within:bg-transparent"
          >
        ...
        <div class="flex-1 overflow-y-auto px-2.5 pb-4">
          <div
            ...
            class="text-center py-16 text-sm text-black/50 dark:text-white/50"
          >
            No members found
          </div>
          <div v-for="member in filteredMembers" :key="member._id" class="relative">
            <div
              class="flex items-center gap-4 px-3.5 py-3 rounded-xl"
              :class="
                member._id?.toString() === userId
                  ? 'cursor-default'
                  : 'cursor-pointer hover:bg-stone-400/10 dark:hover:bg-white/5'
              "
            ...
            >
              <div
                ...
                :style="menuStyle"
              >
                <template v-if="isGroupAdmin(userId)">
                  <button
                    v-if="!isGroupAdmin(member._id)"
                  ...
                  >
                    <svg
                      ...
                      fill="none"
                    >
                      <title>person-shield-check</title>
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                  ...
                  >
                    <svg
                      ...
                      fill="none"
                    >
                      <title>person-shield-remove</title>
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
  ...
  async function handleDismissAdmin(member) {
    ...
    try {
      ...
      chatStore.$patch((state) => {
        state.user.groupAdmins = updated.groupAdmins
      })
    } catch (error) {
