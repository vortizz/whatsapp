<template>
  <div class="flex flex-col">
    ...
    <div class="flex items-center justify-between px-6 py-3">
      <span class="text-sm text-black/60 dark:text-white/60 font-semibold"
    ...
    >
      <div
        class="w-12 h-12 rounded-full bg-emerald-500 flex items-center justify-center text-white dark:text-neutral-950 text-xl flex-none"
      >
    ...
    <div
      ...
      :class="
        member._id?.toString() !== userId
          ? 'cursor-pointer hover:bg-stone-100 dark:hover:bg-white/5'
          : ''
      "
    ...
    >
      ...
      <div class="flex-1 min-w-0">
        ...
        <div v-if="member._id?.toString() !== userId" class="flex">
          ...
          <button
            class="invisible group-hover:visible text-xl"
            @click.stop="toggleMenu(member._id)"
          >
      ...
      <HomeGroupInfoMembersMenu
        :_id="member._id"
        :is-admin="isGroupAdmin(member._id)"
        :current-user-is-admin="isGroupAdmin(userId)"
        :is-menu-open="isMenuOpen === member._id"
