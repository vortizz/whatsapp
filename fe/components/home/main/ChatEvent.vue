<template>
  <div class="flex justify-center my-1">
    <span
      class="bg-white dark:bg-neutral-700 text-black/60 dark:text-neutral-300 text-xs px-3 py-1.5 rounded-lg text-center shadow-[0_1px_0.5px_rgba(11,20,26,0.13)]"
    >
      {{ label }}
    </span>
  </div>
...
<script setup>
  ...
  const doneByName = computed(() => (props.doneBy._id === userId.value ? 'You' : props.doneBy.name))
