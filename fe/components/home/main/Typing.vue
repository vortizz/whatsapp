<template>
    <form @submit.prevent="send">
        <div class="py-3 pl-10 pr-4 w-full bg-gray-100 flex flex-row gap-4 items-center">
            ...
            <div>
                <button v-if="!isLoading" type="submit" :disabled="!message.trim()" class='text-2xl p-2 leading-6 rounded-full active:bg-gray-300 duration-100'>
                    <Icon name="material-symbols:send" />
                </button>
                <button v-else disabled type="button" class='text-2xl p-2 leading-6 rounded-full'>
