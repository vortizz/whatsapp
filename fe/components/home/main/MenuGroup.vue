<template>
    <div class="p-1">
        ...
        >
            <Icon class="text-base" name="material-symbols:group-add-outline-rounded"></Icon>
        ...
        <button @click="exitGroup" class="text-neutral-950 w-full text-left px-4 py-2 hover:bg-rose-600/10 dark:hover:bg-rose-500/10 hover:text-rose-700 dark:hover:text-rose-300 flex items-center gap-3 rounded-xl dark:text-zinc-50">
            <Icon class="text-base" name="material-symbols:logout-rounded"></Icon>
