        ...
        <div v-else class="relative">
            <form @submit.prevent="submit">
                ...
                <div v-if="!loading" class="text-2xl text-gray-400 absolute right-0 inset-y-0 flex flex-row gap-0.5">
                    ...
                    <button type="submit" :disabled="disabledSubmit" class="text-2xl text-neutral-950 dark:text-white">
                        <Icon name="material-symbols:check" />
                    </button>
                </div>
                <div v-else class="absolute right-0 inset-y-0 text-neutral-950">
                    <svg aria-hidden="true" role="status" class="inline w-5 h-5 me-3 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
