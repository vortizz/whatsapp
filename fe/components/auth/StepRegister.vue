<template>
  <div>
    ...
    <div class="flex flex-col mt-6 gap-5">
      ...
      <!-- Email -->
      <div class="flex flex-col gap-1">
        <label for="e-mail" class="uppercase text-xs font-semibold dark:text-zinc-300"
          >E-mail</label
        >
        <input
          id="e-mail"
      ...
      <!-- Confirm Password -->
      <div class="flex flex-col gap-1">
        <label for="confirm-password" class="uppercase text-xs font-semibold dark:text-zinc-300"
